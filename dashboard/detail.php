            ...
            <div class="border rounded-lg overflow-hidden">
                ...
                <div id="collapseCairan" class="block">
                    <div class="p-4 space-y-3">
                        <!-- Oli Mesin -->
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 bg-gray-50 rounded">
                            <span class="font-medium text-gray-700 mb-2 sm:mb-0">Oli Mesin</span>
                            <div class="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
                                ...
                                <?php if (!empty($data['oli_mesin_foto'])): ?>
                                    <div class="relative group">
                                        <img 
                                            src="<?php echo htmlspecialchars(getImagePath($data['oli_mesin_foto'])); ?>" 
                                            alt="Oli Mesin"
                                            class="w-20 h-20 object-cover rounded cursor-pointer hover:opacity-75 transition-opacity"
                                            onclick="viewImage('<?php echo htmlspecialchars(getImagePath($data['oli_mesin_foto'])); ?>')"
                                        />
                                    </div>
                                <?php endif; ?>
                            </div>
