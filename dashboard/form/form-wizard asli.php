                              ...
                              <div>
                                  <h1>                        
                                    ...
                                    if (isset($_SESSION['full_name'])) {
                                        echo "Hello, " . $_SESSION['full_name'] . "!"; // Display user's full name
                                    } else {
            ...
            <div class="row">                
                <div class="col-sm-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="header-title">
                            <h4 class="card-title">ndak tau</h4>
                        </div>
                        </div>
                        <div class="card-body">
                        <form id="form-wizard1" class="mt-3 text-center">
                            ...
                            <!-- ini adalah kotak konfirmasi selesai dari form -->
                                <li class="mb-2 col-lg-3 col-md-6 text-start active" id="data-pribadi">
